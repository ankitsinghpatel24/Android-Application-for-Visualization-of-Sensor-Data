...
public class Activity9 extends AppCompatActivity implements SensorEventListener {
    ...
    private static final String TAG = "activity9";
...
// add entry with timer setting
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if (data != null) {
                    ...
                    data.addEntry(new Entry(set.getEntryCount(), (float) (Math.random() * 1.5) + 21f), 0);
                    ...
                    mChart.getDescription().setText("Temperature Data");
    ...
    private LineDataSet createSet() {
        ...
        LineDataSet set = new LineDataSet(null, "Temperature in °C");
    ...
    protected void onDestroy() {
        mSensorManager.unregisterListener(Activity9.this);
        thread.interrupt();
        super.onDestroy();
    }
}
