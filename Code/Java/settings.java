...
public class settings extends PreferenceActivity {
    ...
    private void Load_setting() {
        ...
        chk_night_instant.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference prefs, Object o) {
        ...
        ListPreference NF = (ListPreference) findPreference("NOTIFICATIONS");
        String notify = sp.getString("NOTIFICATIONS", "false");
        if ("1".equals(notify)) {
            NF.setSummary(NF.getEntry());
        } else if ("2".equals(notify)) {
            NF.setSummary(NF.getEntry()); }
